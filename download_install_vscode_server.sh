...
commit_sha="c3511e6c69bb39013c4a4b7b9566ec1ca73fc4d5"  # v1.67.2
...
cd ~/.vscode-server/bin/"${commit_sha}"
./bin/code-server --install-extension wholroyd.jinja
./bin/code-server --install-extension ms-toolsai.jupyter
./bin/code-server --install-extension ms-python.vscode-pylance
